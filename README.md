...
> ```
> Two computers, two frameworks — one endpoint serves both. _(A CLI listing for remote grids is on the way; for now your remote grid's models show on its web page.)_
