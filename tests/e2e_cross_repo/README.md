...
| Codex protocol drift | A Codex -> B Claude | Schema passes, then `thread/goal/get` returns method-not-found | A is quarantined from Goals but stays online; same turn/checkpoint moves to B and evals pass |
