# Archived six-pattern engineering reference

> **Historical reference.** This document preserves the detailed contracts,
> resource planning, observability, examples, and evidence rules from the
> earlier six-pattern proposal. Its A/L/F taxonomy, admission tests, and
> portable-only exclusions are superseded by the concise
> [local-first pattern catalog](README.md). Read it for engineering mechanics,
> not for the current catalog boundary.

| Historical name | Current pattern |
|---|---|
| A1. Brute-Force Search | **Brute Force** |
| A2. Bounded Verify-and-Repair | **Check and Retry** |
| A3. Diverse Council | **Vote**, **Challenge**, **Diversity Gate** |
| F1. Model Artifact Contract | **Pinned Model** |
| L1. Resident-Set Planner | **Fit the Box**, **Keep It Warm** |
| F2. Boundary-Compiled Graph | **Privacy Boundary** |
| L2. Verified Night Shift | **Idle Worker**, **Night Shift** |
| L3. Energy Envelope | **Power Budget** |
| Sovereign Island | **Offline Island** |
...
This reference develops six mechanisms from two useful families:
