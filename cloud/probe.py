"""Probe a running OpenAI-compatible engine for the capabilities a cloud node advertises on
...
trimmed for the cloud serve path: every call goes through ``httpx.Client`` (so it mocks like the
